     ...
     <div class="midDiv">
         <div class="bgColor">
             ...
             <div class="detailBox">
                 ...
                 <p><b style="font-family: 'Poppins', sans-serif !important">Question:</b> How to start playing?<br><b style="font-family: 'Poppins', sans-serif !important">Answer:</b> After registration in the project you go to the section <a href="/account/farm" style="color: #ffd9a9;">«Buy cows»</a>, where you make necessary buyings. Then <a href="/account/store" style="color: #ffd9a9;">collect milk, sell</a> them and get gold coins and gold bars.</p>
                 ...
                 <p><b style="font-family: 'Poppins', sans-serif !important">Question:</b> How to replenish the account? <br> <b style="font-family: 'Poppins', sans-serif !important">Answer:</b> You can replenish your account in the section <span id="supportReplenishBtn" style="color: #ffd9a9; cursor: pointer;">«Replenish account»</span> in any convenient way for you.</p>
                 ...
                 <p><b style="font-family: 'Poppins', sans-serif !important">Question:</b> How soon can I start withdraw the money?<br> <b style="font-family: 'Poppins', sans-serif !important">Answer:</b> Right away after replenishment and buying cows, in the section <a href="/account/payment" style="color: #ffd9a9;">«Withdraw money»</a>. Before withdrawal of the means you need to collect all the milk to the warehouse and exchange them to gold!</p>
                 ...
                 <p><b style="font-family: 'Poppins', sans-serif !important">Question:</b> I replenished the account, but the money didn't come - what to do?<br> <b style="font-family: 'Poppins', sans-serif !important">Answer:</b> You need to send your referral link <a href="/account/payment" style="color: #ffd9a9;">(https://coin-farm.net/?en=username)</a> to the user whom you want to invite. As soon as this person replenishes the account - he/she will be considered your active referral, and you'll get bonuses for him/her! You can also order a promotion of your referral link in the section <a href="/account/referal" style="color: #ffd9a9;">«Referral promotion»</a>. <a href="" style="color: #ffd9a9;">«My referrals»</a> - here you can track the activity of your referrals!</p>
