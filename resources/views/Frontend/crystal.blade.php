         ...
         <div class="bgColor">
             <div class="descriptionDiv" style="padding: 20px 20px;">
                ...
                <div class="instructionDiv">
                    <p>
                        <b>Gold bars (for withdrawal) and Crystals are resources that are required for ordering withdrawals.</b>
                    </p>
                    <p>
                        <b>1 crystal allows to withdraw 1 USD. For withdrawal of 10 USD you need to have 10 crystals and 73874 gold bars on your account.</b>
                    </p>
                </div>
                <div class="multiCrystalDiv">
                    <div class="commonDiv">
                        <p>Silver coins on your account instead of gold bars:</p>
                        <p>00.0</p>
                    </div>
                    <div class="commonDiv">
                        <p>Gold bars on your account instead of crystal:</p>
                        <p>00.0</p>
                    </div>
                </div>
