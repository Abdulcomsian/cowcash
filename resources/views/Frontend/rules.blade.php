                 ...
                 <div class="main-rulesPara">
                     <div class="rulesPara">
                         ...
                         <p>
                             ...
                             <br>
                             <br>
                             Order of payoffs by the user is restricted by availability of <a href="{{route('account.coins')}}">crystals</a> on the account. 1 crystal gives the right to withdraw 1 EUR (or other user's account currency). Crystals are credited for replenishment of the gold coins account:
                         </p>
                         <p>
