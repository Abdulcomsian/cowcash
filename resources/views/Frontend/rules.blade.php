             ...
             <div class="rulesDiv">
                 ...
                 <div class="rulesPara">
                    <p>
                        ...
                        <br>
                        1.4. Administration of coin-farm.net reserves the right to make any changes and additions to the User's agreement and to the site without noticing the users.
                    </p>
                    <p>
                        <br>
                        ...
                        <br>
                        Game inventory is a conditional playing units which are called "gold" for playing the game, the place of accounting and storing of which is game account of the participant in a computer in the format of accounting system of the playing ground "<a href="/">coin-farm.net</a>".
                        <br>
                        Game account is a virtual account of the participant of the game which is provided by the coordinator to every participant on the playing ground for accounting the game inventory (silver coins, gold bars and crystals).
                        <br><br>
                        ...
                        <br>
                        4.1.3.1. to input the data about him/herself at registration truthfully and at the very first demand of the Coordinator provide with trustworthy data about the personality which allow to identify him/her as the owner of the account;
                        <br>
                        4.1.3.2. not to use the game for making any actions which contradict the international law and the law of the country - residence of the Participant;
                        <br>
                        ...
                        <br>
                        4.1.3.5. not to use for advertising of your partner link, mail distribution and other kinds of massages to people who didn't agree to get them (spam);
                        <br>
                        ...
                        <br>
                        4.1.3.11. not to distribute materials promoting disapproval or hate towards any race, religion, nation, language, politics, country, ideology or social movement;
                        <br>
                        ...
                        <br>
                        4.1.3.18. not to create supplement accounts with the purpose of gaining more referral rewards. Such actions will cause blocking of an account or setting the balance to zero.
                    </p>
                    <p>
                        ...
                        <br>
                        4.2.1.2. to account the game inventory (silver coins, gold bars and crystals) at the Participant's account;
                        <br>
                        ...
                        <br>
                        4.2.1.5. Order of payoffs by the user is restricted by availability of <a href="https://coin-farm.net/account/coins">crystals</a> on the account. 1 crystal gives the right to withdraw 1 EUR (or other user's account currency).
                        Gold Coin are credited for replenishment of the silver coins account:
                        <br>
                        ...
                        <br>
                        4.2.1.6. Any person legally owning the game inventory (gold bars and crystals) is paid with the sum conditioned by the set cost (gold bars and crystals) after deduction of the operational sum;
                        <br><br>
                        4.2.2. The coordinator has right:
                        <br>
                        4.2.2.1. to render the participant additional paid services the list of which and also the order and terms of their using are clarified by the present agreement, rules of the playing ground and other announcements of the Coordinator. Also the Coordinator has the right to change the amount of suggested paid services at any time, their cost, name, kind and effect of the usage;
                        <br>
                        4.2.2.2. to suspend the functioning of the present agreement and disable the participant of playing the game during the inquiry of suspecting the Participant in breaching the agreement and the rules of the playing ground;
                        <br>
                        ...
                        <br>
                        4.2.2.4. to break off the serving partly or totally without noticing the participant at making reconstructions, repair and preventive works on the playing ground;
                        <br>
                    ...
                    <p>
                        ...
                        <br>
                        5.9. The Participant has right to allocate the present Agreement unilaterally without saving the game account. In this case all the expenses connected with participating in the Game are not compensated or returned. The game inventory (silver coins, gold bars and crystals) which are at the Participant's account are not being returned or compensated.
                        <br>
                        5.10. The Coordinator has right to allocate the present Agreement unilaterally and also make other actions which restrict the possibilities in the Game of a participant or a group of participants who are accessories to ascertained breaches of the present Agreement. In this case all the attributes, the game inventory (gold bars and crystals) which are on the account and the game account of the participant or the group of participants and all the expenses are not being returned.
                        <br>
