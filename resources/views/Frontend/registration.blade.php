            ...
            <div id="register" class="container tab-pane {{$errormsg =='These credentials do not match our records.' ? '':'active'}}" style="{{$errormsg =='These credentials do not match our records.' ? 'display: none':''}}">
                ...
                <form class="login100-form validate-form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="formDiv">
                        ...
                        <p class="acceptText"><input type="checkbox" name="" id="termCondition" required="required"> I have read and accept the &nbsp; <a style="display:contents; color: #ffd9a9;" href="https://accrualhub.com/public/rules">rules</a> of the project: </p>
                    </div>
