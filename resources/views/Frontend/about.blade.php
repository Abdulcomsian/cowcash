     ...
     <div class="midDiv aboutSection">
         <div class="bgColor">
             <div class="descriptionDiv" style="padding: 20px;">
                 ...
                 <p>Cow price start with 35 silver coins.</p>
                 ...
                 <p>Even once an hour, even once a day, even once a month! The milk don't disappear or get rotten! Well organized market allows to sell all the milk for silver coins and silver blocks immediately!</p>
                 ...
                 <p>You will find a lot of cow each cow has its own price and its productivity, each subsequent bird will bring more income then the previous one.<br>
                     There are several types of resources in the project - silver block and silver, there are 2 types of silver: <<silver coins>> (for purchase) and <<silver blocks>> (for withdrawal). For silver coins (for purchase), you can buy new cows.<br>
                             Silver block for the withdrawal and silver block you can exchange for real money, and withdraw them to your electronic wallet automaticaly.<br>
