                ...
                <div class="page-header row py-4 justify-content-center">
                    <div class="col-md-9" style=" margin: 70px">
                        <div class="card card-small clinic-card">
                            ...
                            <div class="card-body">
                                <form method="post" action="<?php echo e(route('appointments.store')); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="form-row">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('date')); ?>" type="date" name="date"  id="date" required>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="time" name="time" class="form-control <?php $__errorArgs = ['time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('time')); ?>" id="time" required>
...
unset($__errorArgs, $__bag); ?>" name="type" id="appointment_type" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('contact')); ?>" id="contact" >
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="file" name="audio" class="form-control <?php $__errorArgs = ['audio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('audio')); ?>" id="audio" required>
...
unset($__errorArgs, $__bag); ?>" required> <?php echo e(old('comments')); ?></textarea>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cowcash\resources\views/appointments/create.blade.php ENDPATH**/ ?>