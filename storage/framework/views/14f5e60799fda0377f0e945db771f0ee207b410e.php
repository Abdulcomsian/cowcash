              ...
              <div class="s">
                <div class="d-flex align-content-center align-middle bd-highlight">
                  ...
                  <div class="flex-grow-1 valtop">
                    ...
                    <div class="cont-val"><?php echo e($total_app); ?></div>
                  </div>
                </div>
              </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zine-adminpanel\resources\views/home/dashboard.blade.php ENDPATH**/ ?>