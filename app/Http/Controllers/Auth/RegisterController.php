...
class RegisterController extends Controller
{
    ...
    */
    ...
    protected function create(array $data)
    {
        ...
        $referalcount=User::where(['referred_by'=>$referred_by,'visitorip'=> $ipaddress])->whereDate('created_at', Carbon::today())->count();
        if($referalcount>20)
        {
             toastError('Your referal is exceed using same ip');
            return back();
        }
        $user = User::create([
            'name' => $data['name'],
